...
const Map = () => {
    ...
    const [mapCenter, setMapCenter] = useState<[number, number]>([59.837965, 30.354505]);
    ...
    const markers = [
        {
            id: 0,
            position: point1.split(", ").map(parseFloat),
            title: 'Точка 1',
            description: point1
        },
        {
            id: 1,
            position: point2.split(", ").map(parseFloat),
            title: 'Точка 2',
            description: point2
        ...
        {
            id: 2,
            position: point3.split(", ").map(parseFloat),
            title: 'Точка 3',
            description: point3
        },
    ]
